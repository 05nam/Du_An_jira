  ...
  const updateEstimate = async (taskId, est, timeSpent) => {
    ...
    if (est !== 0) {
      try {
        ...
        console.log(result);
        let result2 = await updateTimeTrackingService(
          taskId,
          timeSpent,
          est - timeSpent
        );
          ...
          <div className="w-100">
            ...
            <div className="comment_button mt-4">
              ...
              <span
                ...
                onClick={() => {
                  deleteComment(com.id, taskDetail.taskId);
                }}
              >
                Delete
              </span>
                ...
                <select className="form-control w-25" name>
                  {taskType.map((task) => {
                    if (task.id === taskDetail.taskTypeDetail.id) {
                      return (
                        <option key={task.id} value={task.id} selected>
                          {task.taskType}
                        </option>
                      );
                    } else {
                  ...
                  <div className="col-7">
                    ...
                    <div className="form-group">
                      ...
                      {ktDes ? (
                        ...
                        >
                          {taskDetail.description.slice(
                            3,
                            taskDetail.description.length - 4
                          )}
                        </p>
                      )}
                    </div>
                    <div className="form-group">
                      ...
                      <div className="d-flex">
                        <img
                          src="https://ui-avatars.com/api/?name=Thanh Quang Tran"
                          className="comment"
                          alt="1"
                        />
                        <Input
                      ...
                      >
                        {status.map((stt) => {
                          if (stt.statusId === taskDetail.statusId) {
                            ...
                            return (
                              <option key={stt.statusId} value={stt.statusId}>
                                {stt.statusName}
                              </option>
                            );
                          }
                        ...
                        <div className="row">
                          ...
                          <div className="col-8">
                            {ktTime ? (
                              ...
                              >
                                {taskDetail.timeTrackingSpent}h
                              </p>
                            )}
                          </div>
                        </div>
                          ...
                          <div className="col-8">
                            ...
                            <div className="d-flex justify-content-between">
                              <p style={{ fontWeight: "600" }}>
                                {" "}
                                {taskDetail.timeTrackingSpent}(h) spent
                              </p>
                              <p style={{ fontWeight: "600" }}>
