...
export default function ProjectManager() {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (name) => (
        <div>
          <NavLink to={`/projectdetail/${name[1]}`}>{name[0]}</NavLink>
        </div>
      ),
    },
    {
          ...
          {members[0].length > 3 ? (
            <>
              <div className="memberList">
                ...
                <Tag key={members[0][2].userId}>...</Tag>
              ...
              <div className="addMembers">
                <Popover
                  placement="rightTop"
                  title={"Add user"}
                  content={content(members[1])}
                  trigger="click"
                >
                  <Tag
                    key={members[0].userId + 1}
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    value={projectIdEdit.projectName}
                    type="text"
                    className="form-control"
                  />
                </div>
                <div className="form-group">
                  ...
                  <select
                    ...
                    value={projectIdEdit.projectCategory.id}
                    className="form-control"
                  >
                ...
                <JoditEditor
                  ...
                  name="description"
                  value={projectIdEdit.description}
                />
